...
template<> struct bsatn_type_id<SpacetimeDb::sdk::ConnectionId> { 
    static constexpr bool is_primitive = true;
    static constexpr uint8_t value = bsatn_type::U64; 
};

template<> struct bsatn_type_id<SpacetimeDb::sdk::Timestamp> { 
    static constexpr bool is_primitive = true;
    static constexpr uint8_t value = bsatn_type::U64; 
};
...
inline void write_algebraic_type(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::Identity*) {
    buf.push_back(bsatn_type::ARRAY);  // Array type
...
void write_field_type(std::vector<uint8_t>& buf) {
    if constexpr (std::is_enum_v<T>) {
        ...
        write_algebraic_type(buf, static_cast<SpacetimeDb::sdk::Identity*>(nullptr));
...
void serialize_value(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::Identity& val);
void serialize_value(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::ConnectionId& val);
void serialize_value(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::Timestamp& val);
...
inline void serialize_value(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::Identity& val) {
...
inline void serialize_value(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::ConnectionId& val) {
    serialize_value(buf, val.id);
}

inline void serialize_value(std::vector<uint8_t>& buf, const SpacetimeDb::sdk::Timestamp& val) {
