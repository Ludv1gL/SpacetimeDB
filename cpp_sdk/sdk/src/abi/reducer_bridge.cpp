...
int16_t __call_reducer__(
    ...
    // Use RAII for BytesSource and BytesSink to ensure _done is called.
    // Note: error_sink_handle is only used if an error occurs.
    SpacetimeDB::Abi::Utils::ManagedBytesSource source_manager(args_source_handle);
