...
void log(LogLevel level, const std::string& message) {
    // Convert SpacetimeDB::LogLevel (which is Abi::LogLevelCpp from common_defs.h, possibly aliased as SpacetimeDB::LogLevel in logging.h)
    // to the C-style ::LogLevel ABI type
    ::LogLevel abi_level = SpacetimeDB::Abi::to_abi(level); // This uses the conversion helper
