...
// Minimal sdk_test implementation - iteration 1
// Focus: Get a basic working module with one table published successfully
...
extern "C" {
    ...
    void __describe_module__(uint32_t sink) {
        // Use the exact same minimal structure that worked before
        uint8_t data[] = {
