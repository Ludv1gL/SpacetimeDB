...
namespace sdk_test_cpp {
    ...
    SPACETIMEDB_TYPE_ENUM(sdk_test_cpp::EnumWithPayloadTag, EnumWithPayloadTag, "EnumWithPayloadTag", ({
...
#define ONE_U8_ROW_FIELDS(XX) XX(uint8_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneU8Row, OneU8Row, "OneU8Row", ONE_U8_ROW_FIELDS,
...
#define ONE_U16_ROW_FIELDS(XX) XX(uint16_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneU16Row, OneU16Row, "OneU16Row", ONE_U16_ROW_FIELDS,
...
#define ONE_U32_ROW_FIELDS(XX) XX(uint32_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneU32Row, OneU32Row, "OneU32Row", ONE_U32_ROW_FIELDS,
...
#define ONE_U64_ROW_FIELDS(XX) XX(uint64_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneU64Row, OneU64Row, "OneU64Row", ONE_U64_ROW_FIELDS,
...
#define ONE_U128_ROW_FIELDS(XX) XX(spacetimedb::sdk::u128, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneU128Row, OneU128Row, "OneU128Row", ONE_U128_ROW_FIELDS,
...
#define ONE_U256_ROW_FIELDS(XX) XX(spacetimedb::sdk::u256, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneU256Row, OneU256Row, "OneU256Row", ONE_U256_ROW_FIELDS,
...
#define ONE_I8_ROW_FIELDS(XX) XX(int8_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneI8Row, OneI8Row, "OneI8Row", ONE_I8_ROW_FIELDS,
...
#define ONE_I16_ROW_FIELDS(XX) XX(int16_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneI16Row, OneI16Row, "OneI16Row", ONE_I16_ROW_FIELDS,
...
#define ONE_I32_ROW_FIELDS(XX) XX(int32_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneI32Row, OneI32Row, "OneI32Row", ONE_I32_ROW_FIELDS,
...
#define ONE_I64_ROW_FIELDS(XX) XX(int64_t, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneI64Row, OneI64Row, "OneI64Row", ONE_I64_ROW_FIELDS,
...
#define ONE_I128_ROW_FIELDS(XX) XX(spacetimedb::sdk::i128, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneI128Row, OneI128Row, "OneI128Row", ONE_I128_ROW_FIELDS,
...
#define ONE_I256_ROW_FIELDS(XX) XX(spacetimedb::sdk::i256, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneI256Row, OneI256Row, "OneI256Row", ONE_I256_ROW_FIELDS,
...
#define ONE_BOOL_ROW_FIELDS(XX) XX(bool, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneBoolRow, OneBoolRow, "OneBoolRow", ONE_BOOL_ROW_FIELDS,
...
#define ONE_F32_ROW_FIELDS(XX) XX(float, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneF32Row, OneF32Row, "OneF32Row", ONE_F32_ROW_FIELDS,
        ({ SPACETIMEDB_FIELD("n", SpacetimeDb::CoreType::F32, false, false) })
    );
...
#define ONE_F64_ROW_FIELDS(XX) XX(double, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneF64Row, OneF64Row, "OneF64Row", ONE_F64_ROW_FIELDS,
...
#define ONE_STRING_ROW_FIELDS(XX) XX(std::string, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneStringRow, OneStringRow, "OneStringRow", ONE_STRING_ROW_FIELDS,
...
#define ONE_IDENTITY_ROW_FIELDS(XX) XX(spacetimedb::sdk::Identity, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneIdentityRow, OneIdentityRow, "OneIdentityRow", ONE_IDENTITY_ROW_FIELDS,
...
#define ONE_CONNECTION_ID_ROW_FIELDS(XX) XX(spacetimedb::sdk::ConnectionId, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneConnectionIdRow, OneConnectionIdRow, "OneConnectionIdRow", ONE_CONNECTION_ID_ROW_FIELDS,
...
#define ONE_TIMESTAMP_ROW_FIELDS(XX) XX(spacetimedb::sdk::Timestamp, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneTimestampRow, OneTimestampRow, "OneTimestampRow", ONE_TIMESTAMP_ROW_FIELDS,
...
#define ONE_SIMPLE_ENUM_ROW_FIELDS(XX) XX(sdk_test_cpp::SimpleEnum, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneSimpleEnumRow, OneSimpleEnumRow, "OneSimpleEnumRow", ONE_SIMPLE_ENUM_ROW_FIELDS,
...
#define ONE_ENUM_WITH_PAYLOAD_ROW_FIELDS(XX) XX(sdk_test_cpp::EnumWithPayload, n, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneEnumWithPayloadRow, OneEnumWithPayloadRow, "OneEnumWithPayloadRow", ONE_ENUM_WITH_PAYLOAD_ROW_FIELDS,
...
#define ONE_UNIT_STRUCT_ROW_FIELDS(XX) XX(sdk_test_cpp::UnitStruct, s, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneUnitStructRow, OneUnitStructRow, "OneUnitStructRow", ONE_UNIT_STRUCT_ROW_FIELDS,
...
#define ONE_BYTE_STRUCT_ROW_FIELDS(XX) XX(sdk_test_cpp::ByteStruct, s, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneByteStructRow, OneByteStructRow, "OneByteStructRow", ONE_BYTE_STRUCT_ROW_FIELDS,
...
#define ONE_EVERY_PRIMITIVE_STRUCT_ROW_FIELDS(XX) XX(sdk_test_cpp::EveryPrimitiveStruct, s, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneEveryPrimitiveStructRow, OneEveryPrimitiveStructRow, "OneEveryPrimitiveStructRow", ONE_EVERY_PRIMITIVE_STRUCT_ROW_FIELDS,
...
#define ONE_EVERY_VEC_STRUCT_ROW_FIELDS(XX) XX(sdk_test_cpp::EveryVecStruct, s, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OneEveryVecStructRow, OneEveryVecStructRow, "OneEveryVecStructRow", ONE_EVERY_VEC_STRUCT_ROW_FIELDS,
...
#define VEC_U8_ROW_FIELDS(XX) XX(uint8_t, n, false, true)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::VecU8Row, VecU8Row, "VecU8Row", VEC_U8_ROW_FIELDS,
...
#define VEC_STRING_ROW_FIELDS(XX) XX(std::string, n, false, true)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::VecStringRow, VecStringRow, "VecStringRow", VEC_STRING_ROW_FIELDS,
        ({ SPACETIMEDB_FIELD("n", SpacetimeDb::CoreType::String, false, false) })
    );
...
#define VEC_SIMPLE_ENUM_ROW_FIELDS(XX) XX(sdk_test_cpp::SimpleEnum, n, false, true)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::VecSimpleEnumRow, VecSimpleEnumRow, "VecSimpleEnumRow", VEC_SIMPLE_ENUM_ROW_FIELDS,
        ({ SPACETIMEDB_FIELD_CUSTOM("n", "SimpleEnum", false, false) })
    );
...
#define VEC_EVERY_PRIMITIVE_STRUCT_ROW_FIELDS(XX) XX(sdk_test_cpp::EveryPrimitiveStruct, s, false, true)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::VecEveryPrimitiveStructRow, VecEveryPrimitiveStructRow, "VecEveryPrimitiveStructRow", VEC_EVERY_PRIMITIVE_STRUCT_ROW_FIELDS,
        ({ SPACETIMEDB_FIELD_CUSTOM("s", "EveryPrimitiveStruct", false, false) })
    );
...
#define UNIQUE_U8_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::UniqueU8Row, UniqueU8Row, "UniqueU8Row", UNIQUE_U8_ROW_FIELDS,
        ({
...
#define UNIQUE_STRING_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::UniqueStringRow, UniqueStringRow, "UniqueStringRow", UNIQUE_STRING_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
...
#define UNIQUE_IDENTITY_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::UniqueIdentityRow, UniqueIdentityRow, "UniqueIdentityRow", UNIQUE_IDENTITY_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
...
#define UNIQUE_CONNECTION_ID_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::UniqueConnectionIdRow, UniqueConnectionIdRow, "UniqueConnectionIdRow", UNIQUE_CONNECTION_ID_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
...
#define LARGE_TABLE_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::LargeTableRow, LargeTableRow, "LargeTableRow", LARGE_TABLE_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
            SPACETIMEDB_FIELD("a", SpacetimeDb::CoreType::U8, false, false),
            SPACETIMEDB_FIELD("b", SpacetimeDb::CoreType::U16, false, false),
...
#define TABLE_HOLDS_TABLE_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::TableHoldsTableRow, TableHoldsTableRow, "TableHoldsTableRow", TABLE_HOLDS_TABLE_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
...
#define SCHEDULED_TABLE_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::ScheduledTableRow, ScheduledTableRow, "ScheduledTableRow", SCHEDULED_TABLE_ROW_FIELDS,
        ({
...
#define INDEXED_TABLE_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::IndexedTableRow, IndexedTableRow, "IndexedTableRow", INDEXED_TABLE_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
...
#define INDEXED_TABLE_2_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::IndexedTable2Row, IndexedTable2Row, "IndexedTable2Row", INDEXED_TABLE_2_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
            SPACETIMEDB_FIELD("player_id", SpacetimeDb::CoreType::U32, false, false),
...
#define BTREE_U32_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::BTreeU32Row, BTreeU32Row, "BTreeU32Row", BTREE_U32_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
...
#define USERS_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::UsersRow, UsersRow, "UsersRow", USERS_ROW_FIELDS,
        ({
...
#define INDEXED_SIMPLE_ENUM_ROW_FIELDS(XX) \
    ...
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::IndexedSimpleEnumRow, IndexedSimpleEnumRow, "IndexedSimpleEnumRow", INDEXED_SIMPLE_ENUM_ROW_FIELDS,
        ({
            SPACETIMEDB_FIELD("row_id", SpacetimeDb::CoreType::U64, false, true),
            SPACETIMEDB_FIELD_CUSTOM("n", "SimpleEnum", false, false)
            })
...
#define PK_U8_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::PkU8Row, PkU8Row, "PkU8Row", PK_U8_ROW_FIELDS,
        ({
...
#define PK_STRING_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::PkStringRow, PkStringRow, "PkStringRow", PK_STRING_ROW_FIELDS,
        ({
...
#define PK_IDENTITY_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::PkIdentityRow, PkIdentityRow, "PkIdentityRow", PK_IDENTITY_ROW_FIELDS,
        ({
...
#define PK_SIMPLE_ENUM_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::PkSimpleEnumRow, PkSimpleEnumRow, "PkSimpleEnumRow", PK_SIMPLE_ENUM_ROW_FIELDS,
        ({
...
#define PK_U32_TWO_ROW_FIELDS(XX) \
    ...
    XX(int32_t, data, false, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::PkU32TwoRow, PkU32TwoRow, "PkU32TwoRow", PK_U32_TWO_ROW_FIELDS,
        ({
...
#define OPTION_I32_ROW_FIELDS(XX) XX(int32_t, n, true, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::OptionI32Row, OptionI32Row, "OptionI32Row", OPTION_I32_ROW_FIELDS,
...
#define OPTION_STRING_ROW_FIELDS(XX) XX(std::string, n, true, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::OptionStringRow, OptionStringRow, "OptionStringRow", OPTION_STRING_ROW_FIELDS,
...
#define OPTION_IDENTITY_ROW_FIELDS(XX) XX(spacetimedb::sdk::Identity, n, true, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::OptionIdentityRow, OptionIdentityRow, "OptionIdentityRow", OPTION_IDENTITY_ROW_FIELDS,
...
#define OPTION_SIMPLE_ENUM_ROW_FIELDS(XX) XX(sdk_test_cpp::SimpleEnum, n, true, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::OptionSimpleEnumRow, OptionSimpleEnumRow, "OptionSimpleEnumRow", OPTION_SIMPLE_ENUM_ROW_FIELDS,
...
#define OPTION_EVERY_PRIMITIVE_STRUCT_ROW_FIELDS(XX) XX(sdk_test_cpp::EveryPrimitiveStruct, s, true, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(sdk_test_cpp::OptionEveryPrimitiveStructRow, OptionEveryPrimitiveStructRow, "OptionEveryPrimitiveStructRow", OPTION_EVERY_PRIMITIVE_STRUCT_ROW_FIELDS,
...
#define VEC_OPTION_I32_FIELDS(XX) XX(std::optional<int32_t>, value, false, true)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::VecOptionI32, VecOptionI32, "VecOptionI32", VEC_OPTION_I32_FIELDS,
...
#define OPTION_VEC_OPTION_I32_ROW_FIELDS(XX) XX(sdk_test_cpp::VecOptionI32, v, true, false)
    SPACETIMEDB_TYPE_STRUCT_WITH_FIELDS(
        sdk_test_cpp::OptionVecOptionI32Row, OptionVecOptionI32Row, "OptionVecOptionI32Row", OPTION_VEC_OPTION_I32_ROW_FIELDS,
