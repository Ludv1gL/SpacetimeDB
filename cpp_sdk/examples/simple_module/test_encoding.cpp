...
extern "C" {
    ...
    void __describe_module__(uint32_t sink) {
        ...
        // Typespace with 1 type - let's test different type encodings
        w.write_u32_le(1);
        
        // Let's try different discriminants for U8
        // Based on the enum order in algebraic_type.rs:
        // Ref = 0, Sum = 1, Product = 2, Array = 3, String = 4, 
        // Bool = 5, I8 = 6, U8 = 7, I16 = 8, U16 = 9, I32 = 10, U32 = 11,
        // I64 = 12, U64 = 13, I128 = 14, U128 = 15, I256 = 16, U256 = 17, F32 = 18, F64 = 19
        
        // Type 0: Product type with U8 field
        w.write_u8(2);  // Product type
        w.write_u32_le(1);  // 1 field
        // Field: n (u8)
        w.write_u8(0);  // Some (field name present)
        w.write_string("n");
        w.write_u8(7); // U8 should be discriminant 7
