...
struct EnumWithPayload {
    ...
    static EnumWithPayload from_str(const std::string& v) { EnumWithPayload e; e.tag = Tag::Str; new (&e.str) std::string(v); return e; }
    ...
    static EnumWithPayload from_bytes(const std::vector<uint8_t>& v) { EnumWithPayload e; e.tag = Tag::Bytes; new (&e.bytes) std::vector<uint8_t>(v); return e; }
    static EnumWithPayload from_ints(const std::vector<int32_t>& v) { EnumWithPayload e; e.tag = Tag::Ints; new (&e.ints) std::vector<int32_t>(v); return e; }
    static EnumWithPayload from_strings(const std::vector<std::string>& v) { EnumWithPayload e; e.tag = Tag::Strings; new (&e.strings) std::vector<std::string>(v); return e; }
    static EnumWithPayload from_simple_enums(const std::vector<SimpleEnum>& v) { EnumWithPayload e; e.tag = Tag::SimpleEnums; new (&e.simple_enums) std::vector<SimpleEnum>(v); return e; }
};
...
// Define tables for single values
SPACETIMEDB_TABLE(OneU8, one_u8, public, uint8_t n);
SPACETIMEDB_TABLE(OneU16, one_u16, public, uint16_t n);
SPACETIMEDB_TABLE(OneU32, one_u32, public, uint32_t n);
SPACETIMEDB_TABLE(OneU64, one_u64, public, uint64_t n);
SPACETIMEDB_TABLE(OneU128, one_u128, public, U128 n);
SPACETIMEDB_TABLE(OneU256, one_u256, public, U256 n);

SPACETIMEDB_TABLE(OneI8, one_i8, public, int8_t n);
SPACETIMEDB_TABLE(OneI16, one_i16, public, int16_t n);
SPACETIMEDB_TABLE(OneI32, one_i32, public, int32_t n);
SPACETIMEDB_TABLE(OneI64, one_i64, public, int64_t n);
SPACETIMEDB_TABLE(OneI128, one_i128, public, I128 n);
SPACETIMEDB_TABLE(OneI256, one_i256, public, I256 n);

SPACETIMEDB_TABLE(OneBool, one_bool, public, bool b);
SPACETIMEDB_TABLE(OneF32, one_f32, public, float f);
SPACETIMEDB_TABLE(OneF64, one_f64, public, double f);
SPACETIMEDB_TABLE(OneString, one_string, public, std::string s);

SPACETIMEDB_TABLE(OneIdentity, one_identity, public, SpacetimeDb::Identity i);
SPACETIMEDB_TABLE(OneConnectionId, one_connection_id, public, SpacetimeDb::ConnectionId a);
SPACETIMEDB_TABLE(OneTimestamp, one_timestamp, public, SpacetimeDb::Timestamp t);

SPACETIMEDB_TABLE(OneSimpleEnum, one_simple_enum, public, SimpleEnum e);
SPACETIMEDB_TABLE(OneEnumWithPayload, one_enum_with_payload, public, EnumWithPayload e);

SPACETIMEDB_TABLE(OneUnitStruct, one_unit_struct, public, UnitStruct s);
SPACETIMEDB_TABLE(OneByteStruct, one_byte_struct, public, ByteStruct s);
SPACETIMEDB_TABLE(OneEveryPrimitiveStruct, one_every_primitive_struct, public, EveryPrimitiveStruct s);
SPACETIMEDB_TABLE(OneEveryVecStruct, one_every_vec_struct, public, EveryVecStruct s);

// Reducers for single value inserts
SPACETIMEDB_REDUCER(insert_one_u8, ctx, uint8_t n) {
    ctx.insert(OneU8{n});
}

SPACETIMEDB_REDUCER(insert_one_u16, ctx, uint16_t n) {
    ctx.insert(OneU16{n});
}

SPACETIMEDB_REDUCER(insert_one_u32, ctx, uint32_t n) {
    ctx.insert(OneU32{n});
}

SPACETIMEDB_REDUCER(insert_one_u64, ctx, uint64_t n) {
    ctx.insert(OneU64{n});
}

SPACETIMEDB_REDUCER(insert_one_u128, ctx, U128 n) {
    ctx.insert(OneU128{n});
}

SPACETIMEDB_REDUCER(insert_one_u256, ctx, U256 n) {
    ctx.insert(OneU256{n});
}

SPACETIMEDB_REDUCER(insert_one_i8, ctx, int8_t n) {
    ctx.insert(OneI8{n});
}

SPACETIMEDB_REDUCER(insert_one_i16, ctx, int16_t n) {
    ctx.insert(OneI16{n});
}

SPACETIMEDB_REDUCER(insert_one_i32, ctx, int32_t n) {
    ctx.insert(OneI32{n});
}

SPACETIMEDB_REDUCER(insert_one_i64, ctx, int64_t n) {
    ctx.insert(OneI64{n});
}

SPACETIMEDB_REDUCER(insert_one_i128, ctx, I128 n) {
    ctx.insert(OneI128{n});
}

SPACETIMEDB_REDUCER(insert_one_i256, ctx, I256 n) {
...
SPACETIMEDB_TABLE(VecU8, vec_u8, public, std::vector<uint8_t> n);
SPACETIMEDB_TABLE(VecU16, vec_u16, public, std::vector<uint16_t> n);
SPACETIMEDB_TABLE(VecU32, vec_u32, public, std::vector<uint32_t> n);
SPACETIMEDB_TABLE(VecU64, vec_u64, public, std::vector<uint64_t> n);
SPACETIMEDB_TABLE(VecU128, vec_u128, public, std::vector<U128> n);
SPACETIMEDB_TABLE(VecU256, vec_u256, public, std::vector<U256> n);

SPACETIMEDB_TABLE(VecI8, vec_i8, public, std::vector<int8_t> n);
SPACETIMEDB_TABLE(VecI16, vec_i16, public, std::vector<int16_t> n);
SPACETIMEDB_TABLE(VecI32, vec_i32, public, std::vector<int32_t> n);
SPACETIMEDB_TABLE(VecI64, vec_i64, public, std::vector<int64_t> n);
SPACETIMEDB_TABLE(VecI128, vec_i128, public, std::vector<I128> n);
SPACETIMEDB_TABLE(VecI256, vec_i256, public, std::vector<I256> n);
